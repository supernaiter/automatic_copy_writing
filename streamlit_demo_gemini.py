...
# APIキー設定（Streamlit Cloud secrets優先、次に環境変数、最後にデフォルト値）
def get_api_key():
...
【重要な制約】
- 商品名やブランド名は一切使用しないでください
- 商品の本質的な価値や体験に焦点を当ててください
- 生活者の感情や体験を直接的に表現してください
"""
