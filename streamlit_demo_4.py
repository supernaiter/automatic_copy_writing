...
STAGED_PROMPTS = [
    {
        "stage": 1,
        "title": "💡 what to say生成",
        "prompt": "まだ綺麗に言語化されて大衆に共有されていないが、先見の明を持つ人が発見している価値や、多くの人がなんとなく、無意識にいいなと思っているが言語化されていない価値をwhat to sayとして20案作成してください。\n\n※「what to say」とは「メッセージは何か」あるいは、その企画を通して「何を残すのか」「何を持ち帰ってもらうのか」という意味です。\n\n前置きや説明文は不要。what to sayのみを出力してください。",
        "description": "潜在的価値を発見し、20個のwhat to sayを生成"
    },
    {
        "stage": 2,
        "title": "🎯 とりあえず生成",
        "prompt": "生活者にとって新しい価値を発見できるwhat to say を２０案考えて、その上で二十個のコピーを作成せよ。\n\n※「what to say」とは「メッセージは何か」あるいは、その企画を通して「何を残すのか」「何を持ち帰ってもらうのか」という意味です。\n\n前置きや説明文は不要。コピーのみを出力してください。",
        "description": "20個のwhat to sayに基づく、20個のコピーを作成"
    },
    {
        "stage": 3,
        "title": "⚡ 強化・改善",
...
"""
            ...
            system_message = {
                "role": "system", 
                "content": """あなたは挑戦的で常識に囚われないコピーライターです。
与えられたオリエンテーション情報を活用し、効果的なキャッチコピーを作成してください。
        ...
        if st.session_state.staged_results:
            ...
            with col_reflect:
                ...
                if st.button(
                    ...
                    # 段階別の自省プロンプトを作成
                    if latest_stage == 1:  # what to say生成段階
                        reflect_prompt = f"""
これまでのwhat to sayを自省してください：

{latest_result}

上記の結果を厳しく分析し、以下の観点から改善してください：
1. 普通すぎる、どこでも聞くような当たり前のことではないか？
2. 表層的すぎる、もっと深い人間の本質的な欲求や感情に触れられないか？
3. 使った人にしかわからない体験的なインサイトが含まれているか？
4. まだ言語化されていない、無意識レベルの価値を発見できているか？
5. 先見の明を持つ人だけが気づいている隠れた価値を見つけられているか？

もっと深く、ユニークで、体験者だけが知る隠れた価値を20案再生成してください。
"""
                    else:  # その他の段階
                        reflect_prompt = f"""
これまでの結果を自省してください：
